...
let nimiPainike = document.querySelector("#nimiPainike");
let kaikkiPainike = document.querySelector("#kaikkiPainike");
let kaikki = obj.employees;
let i = 0

nimiPainike.addEventListener('click', function () {
    let tulos = "";

    for (i = 0; i < kaikki.length; i++) {
        tulos += kaikki[i].firstName + " " + kaikki[i].lastName + ", ";

    document.querySelector("#jsondata").innerHTML = tulos;
